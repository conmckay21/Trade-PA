      ...
      {tab === "pending" && (() => {
        ...
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, gap: 8, flexWrap: "wrap" }}>
            <div style={{ fontSize: 11, color: IC.muted }}>Trade PA reviews your inbox every hour and suggests actions for your approval.</div>
          ...
          {pendingActions.length === 0 ? (
            <div style={{ ...IS.card, textAlign: "center", padding: 40 }}>
              ...
              <div style={{ fontSize: 12, color: IC.muted, lineHeight: 1.6 }}>No pending actions. Trade PA will check your inbox again on the next hour and suggest actions for any new emails.</div>
            </div>
