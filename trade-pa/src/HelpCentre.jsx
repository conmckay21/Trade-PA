...
const ARTICLES = [
  ...
  {
    slug: "ai-tools-list",
    title: "What can my PA do? A reference",
    category: "voice-ai",
    summary: "Real examples of what to say. Your PA gets intent — you don't have to phrase it word-for-word.",
    steps: [
      "ADD STUFF: customers, jobs, materials, suppliers, subbies, enquiries, reminders, mileage logs, expenses. Just say 'add' or 'new' and what it is.",
      "GET PAID: create quotes, send invoices, convert a quote to an invoice, mark as paid, chase overdue, set up stage payments.",
      "UPDATE: change a job's status (in progress, completed, on hold), mark an invoice paid, update a material price, change a quote.",
      "FIND: a job, customer, quote, invoice, material or receipt by name, number, address, or what it was for.",
      "BOOK & PLAN: put jobs in the diary for specific dates, see this week's schedule, set reminders, reschedule.",
      "CALL & MESSAGE: call a customer, text them an update, email a supplier order, triage the Inbox.",
      "COMPLIANCE: generate RAMS for a job, log certificates, store worker documents.",
      "BRAND & SETTINGS: update your trading name, VAT number, address, bank details, or change your PA's voice and persona.",
    ],
    voicePrompts: [
      "Add Mrs Patel as a new customer, 14 Beech Road, 0117 555 0100",
      "Book in the Khan boiler service for Tuesday morning",
      "Log a new enquiry from Jake — wants a kitchen rewire, ballpark £2k",
      "Add 50 metres of 2.5mm twin and earth to the Patel job, £75",
      "Scan this receipt — Wickes, £42, for the Beech Road job",
      "Quote £2,400 for the kitchen rewire on Monday",
      "Invoice Patel £580 for the second-fix work",
      "Mark invoice 28 as paid",
      "Chase the overdue invoices",
      "Log 22 miles to the Mill Lane job today",
      "Log £45 fuel from Esso today",
      "Call Mrs Patel",
      "Text Khan, running 10 minutes late",
      "Order 4 sheets of 18mm ply from Wickes for the Beech Road job",
      "Mark the Patel job as completed",
      "Find the invoice I sent to Khan last month",
      "Show me everything unpaid this week",
      "Update my VAT number to GB123456789",
      "Generate RAMS for the dormer roof job",
      "Set a reminder to chase Patel on Friday",
    ],
    tips: [
      "If you're not sure what to say, just talk normally — your PA gets intent, not exact wording.",
      "Mention the customer or job name and PA will find it — no need to remember reference numbers.",
      "Add 'today' or a specific date to anything time-related — mileage, expenses, jobs.",
      "Anything your PA does, you can also do by tapping through the app — voice is one option, not the only way.",
    ],
    related: ["voice-fill", "ai-assistant", "hands-free", "ai-memory", "ai-wrong-result", "voice-not-working"],
  },
  ...
  // ─── Billing, trial & limits ────────────────────────────────────────────
  {
    ...
    category: "getting-paid",
    summary: "Every plan starts with a 30-day free trial. No charge until day 31 — cancel anytime before then and you pay nothing.",
    steps: [
      "Pick any plan when you sign up — Solo, Pro Solo, Team or Business.",
      "Enter your card details. The card is saved but not charged.",
      "Use the app as normal for 30 days — everything is unlocked.",
      "On day 31 the first payment is taken automatically, unless you cancel before then.",
    ],
    tips: [
      "During the trial you get a generous taster allowance (50 conversations, 30 minutes hands-free) regardless of which plan you picked. Your full plan caps kick in the moment your first payment is taken on day 31.",
      "You can switch plans at any point during the trial — your trial window stays the same, only the plan you'll be charged for changes.",
      "Your trial end date is shown in Settings → Plan & billing.",
    ],
    related: ["cancel-trial", "subscription-plans", "manage-billing"],
  },
  {
    slug: "cancel-trial",
    title: "Cancel before your trial ends",
    category: "getting-paid",
    summary: "Cancel any time before day 31 and you won't be charged. It takes about 30 seconds.",
    steps: [
      "Tap Settings → Plan & billing.",
      "Tap Manage → (on iPhone native app: tap Open web → and sign in on tradespa.co.uk first).",
      "The Stripe billing portal opens in a new tab.",
      "Tap Cancel subscription. Confirm.",
      "You'll see a confirmation email from Stripe. You're done — no charge will be taken.",
    ],
    tips: [
      "You can keep using Trade PA for the rest of the trial after you cancel — access ends on the day your trial would have converted.",
      "If you change your mind, just start a new subscription from Settings before the trial ends.",
      "iOS native app users: Apple requires subscription management on the web. Tap Open web and use the same flow on tradespa.co.uk.",
    ],
    related: ["free-trial", "manage-billing"],
  },
  {
    slug: "subscription-plans",
    title: "Solo, Pro Solo, Team or Business — which plan fits",
    category: "getting-paid",
    summary: "Four tiers. Same core features. What changes is users and monthly capacity.",
    steps: [
      "Solo — £39/mo. 1 user. 100 AI conversations and 1 hour hands-free per month. Best if you're a sole trader and use voice occasionally.",
      "Pro Solo — £59/mo. 1 user. 200 AI conversations and 3 hours hands-free per month. Best if you're a busy sole trader who voices most of your admin.",
      "Team — £89/mo. Up to 5 users. 400 AI conversations and 4 hours hands-free per month. Includes team scheduling, per-user permissions, staff timesheets and GPS.",
      "Business — £129/mo. Up to 10 users. 800 AI conversations and 8 hours hands-free per month. Includes priority support and the highest capacity.",
      "Every plan includes every feature — voice AI, hands-free, invoicing, Xero/QuickBooks, Twilio phone add-ons, the lot.",
    ],
    tips: [
      "All plans are monthly — no annual lock-in. Switch up or down any time from Settings → Plan & billing without losing data.",
      "Start on Solo if you're a sole trader — the moment you need more capacity or more users, step up. Nothing is lost in the switch.",
      "Heavy solo users: Pro Solo doubles your capacity for £20 more. If you'd also benefit from extra seats, Team is usually the better-value step up.",
    ],
    related: ["free-trial", "monthly-limits", "manage-billing"],
  },
  {
    slug: "monthly-limits",
    title: "Monthly conversation and hands-free limits",
    category: "getting-paid",
    summary: "Every plan has a monthly cap on AI conversations and hands-free time. Here's what each plan includes and when it resets.",
    steps: [
      "Trial (any plan, days 1–30): 50 conversations, 30 minutes hands-free.",
      "Solo: 100 conversations, 1 hour hands-free per month.",
      "Pro Solo: 200 conversations, 3 hours hands-free per month.",
      "Team: 400 conversations, 4 hours hands-free per month.",
      "Business: 800 conversations, 8 hours hands-free per month.",
      "Limits reset on your monthly billing date — not on the 1st of the calendar month.",
      "If you hit the cap, the AI will let you know and point you at either upgrading your plan or buying a top-up add-on.",
    ],
    tips: [
      "A 'conversation' is one back-and-forth exchange with the AI Assistant — not a single word or tap. Most people use a small fraction of their monthly allowance.",
      "Hands-free time counts the period your mic is in always-listening mode, not just when the AI is actively responding. Tap-to-talk voice never counts toward this cap.",
      "Heavy users: upgrade one tier rather than stacking add-ons — it's usually cheaper per conversation.",
    ],
    related: ["subscription-plans", "manage-billing", "hands-free"],
  },
  {
    slug: "business-phone-tiers",
    title: "Business phone plans — minutes and what happens when you hit the cap",
    category: "getting-paid",
    summary: "Four phone plans, each with a monthly minute allowance. Trade PA warns you before you run out — and falls back to voicemail rather than cutting you off.",
    steps: [
      "Pick a phone plan in Settings → Business Phone. Each plan includes a monthly minute allowance and a UK business number.",
      "Make and receive calls normally. Your usage is tracked in real time.",
      "When you hit 80% of your monthly allowance, you'll see an amber warning on the Business Phone screen.",
      "At 100%, new incoming calls go straight to voicemail — so customers still get through, they just leave a message instead of ringing you.",
      "Voicemails are transcribed and logged against the customer, same as always.",
      "The minute counter resets on your monthly billing date.",
    ],
    tips: [
      "The colour bar on the Business Phone screen is your at-a-glance check — green under 80%, amber over 80%, red when you're at or over cap.",
      "Heavy phone users should pick a higher tier rather than bumping the cap every month — the per-minute rate is cheaper.",
      "Outbound calls also count toward the minute cap, not just inbound.",
    ],
    related: ["business-phone", "make-call", "receive-call", "manage-billing"],
  },
  {
    slug: "manage-billing",
    title: "Update your card, download invoices, cancel or switch plan",
    category: "getting-paid",
    summary: "All billing lives in the Stripe billing portal. One button in Settings takes you there.",
    steps: [
      "Tap Settings → Plan & billing.",
      "Tap Manage → to open the Stripe billing portal. (On iPhone native app: tap Open web → and do the same from tradespa.co.uk.)",
      "From the portal you can: update your card, view and download every invoice as a PDF, change plan, cancel, or reactivate after cancelling.",
      "Any change (plan switch, cancellation, card update) takes effect immediately and syncs back to Trade PA.",
    ],
    tips: [
      "Stripe invoices are your VAT-compliant receipts — download the PDF for your own records or to send to your accountant.",
      "If your card is declined, Stripe will retry automatically over a few days and email you each time. If the retries fail, your account drops to trial-level limits until you update the card.",
      "Cancelled by mistake? Tap Manage → Reactivate within the grace period and you're back on — no data lost.",
      "iOS native app: Apple's rules force subscription management to be web-only. The Manage button opens tradespa.co.uk in Safari.",
    ],
