...
const ARTICLES = [
  ...
  // ─── Billing, trial & limits ────────────────────────────────────────────
  {
    ...
    steps: [
      "Pick any plan when you sign up — Solo, Team or Pro.",
    ...
    tips: [
      "During the trial you get Solo-level limits (500 conversations, 5 hands-free hours) regardless of which plan you picked. The higher caps kick in once your first payment is taken on day 31.",
  ...
  },
  {
    ...
    title: "Solo, Team or Pro — which plan fits",
    category: "getting-paid",
    summary: "Three tiers. Same core features. What changes is users and monthly capacity.",
    steps: [
      "Solo — for sole traders. 1 user. Lowest monthly cost. Best for anyone working on their own.",
      "Team — for small crews. £89/mo (or annual). Up to 5 users. Higher monthly conversation and hands-free limits.",
      "Pro — for growing contractors. £129/mo (or annual). Up to 10 users. Highest limits.",
      "Every plan includes every feature — voice AI, hands-free, invoicing, Xero/QuickBooks, Twilio phone add-ons, the lot.",
    ],
    tips: [
      "Annual plans save two months compared to paying monthly — same plan, same features, 16% cheaper.",
  ...
  },
  {
    ...
    category: "getting-paid",
    summary: "Every plan has a monthly cap on AI conversations and hands-free hours. Here's what each plan includes and when it resets.",
    steps: [
      "Solo (and trial): 500 conversations, 5 hands-free hours per month.",
      "Team: 1,500 conversations, 15 hands-free hours per month.",
      "Pro: 2,500 conversations, 25 hands-free hours per month.",
    ...
    tips: [
      ...
      "Hands-free hours count the time your mic is in always-listening mode, not just when the AI is actively responding.",
