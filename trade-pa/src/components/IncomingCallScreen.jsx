  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 9000, background: "linear-gradient(180deg, #0a1628 0%, #0f0f0f 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingTop: "env(safe-area-inset-top, 0px)", paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
      ...
      <div style={{ position: "relative", width: 100, height: 100, marginBottom: 32 }}>
        ...
        <div style={{ width: 100, height: 100, borderRadius: "50%", background: "linear-gradient(135deg,#1e3a5f,#2563eb)", border: "3px solid #3b82f680", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 32, fontWeight: 700, color: "#fff", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{initials}</div>
      </div>
      ...
      {callerNumber && <div style={{ fontSize: 13, color: "#4b5563", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: 60 }}>{callerNumber}</div>}
